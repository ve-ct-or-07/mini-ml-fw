from ml_lib.nn.autograd import Value
import numpy as np
...
class Module:
    ...
    def __init__(self):
        ...
        These dictionaries will store the learnable parameters (Value objects) and sub-modules (other Module objects) contained within this module.
    ...
    These methods are used internally (often via __setattr__) to correctly register parameters and sub-modules so they can be discovered later.
    """
    ...
    def parameters(self):
        ...
        """
        # yield the parameter Value objects (exclude None)
    ...
    def zero_grad(self):
        ...
        for p in self.parameters():
            if p is None:
                continue
            # Ensure grad exists and has correct shape
